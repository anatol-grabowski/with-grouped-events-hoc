  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      var _props = this.props,
          childs = _props.childs,
          onChildEvent = _props.onChildEvent;

      return _react2.default.createElement(
        'div',
        { style: { border: 'solid black 2px' } },
        childs.map(function (child) {
          return _react2.default.createElement(Child, { name: child, onEvent: function onEvent(evt) {
              return onChildEvent(child, evt);
            } });
        })
      );
    }
  ...
  _createClass(Family, [{
    ...
    value: function render() {
      var _props2 = this.props,
          parents = _props2.parents,
          childs = _props2.childs,
          onChildEvent = _props2.onChildEvent;
...
var FamilyWithGroupedEvents = (0, _2.default)(['onChildEvent'])(Family);

var Party = function (_React$Component3) {
  _inherits(Party, _React$Component3);
  ...
  _createClass(Party, [{
    ...
    value: function render() {
      var _props3 = this.props,
          families = _props3.families,
          onChildEvent = _props3.onChildEvent;

      return _react2.default.createElement(
        'div',
        null,
        families.map(function (fam) {
          return _react2.default.createElement(FamilyWithGroupedEvents, {
            parents: fam.parents,
            childs: fam.children,
...
var PartyWithGroupedEvents = (0, _2.default)(['onChildEvent'])(Party);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: { height: '300px' } },
          _react2.default.createElement(Parent, {
            childs: childs,
        ...
        _react2.default.createElement(
          'div',
          { style: { height: '300px' } },
          _react2.default.createElement(PartyWithGroupedEvents, {
            families: families,
...
module.exports = __webpack_require__(15)(exports);
...
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_1__);



const debug = debug__WEBPACK_IMPORTED_MODULE_1___default()('with-grouped-events');
const debugHandlersMap = debug__WEBPACK_IMPORTED_MODULE_1___default()('handlers-map');
...
const withGroupedEvents = handlersProps => (Component) => {
  ...
  class WithGroupedEvents extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, {...props, ...groupedHandlers});
    }
  }
  return WithGroupedEvents;
};

/* harmony default export */ __webpack_exports__["default"] = (withGroupedEvents);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(16);
